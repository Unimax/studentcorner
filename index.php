...
<section>
  ...
  <h3>Don't Fall behind </h3>
  
  <p>If you are behind in required class readings, you will have a lot  of reading to do come finals. Make sure you learn the material the first time  it's taught, so you don't have to go back and review it. Sometimes, if you pay  good attention in class, you can forgo some of the required reading. </p>
  
  <h3>Study Environment </h3>
 
  <p>You can accomplish much more quality study time in an&nbsp;<a href="http://www.campusgrotto.com/best-places-to-study.html">academic like atmosphere</a>than studying at home. Cut  out all distractions while brainstorming to help maintain your train of  thought. Eliminating noisy distractions and working during the day when you are  more alert are also great ways to improve efficiency when studying. </p>
  ...
  <p>Show up at your professors office during office hours. Many  professors office hours go unused by students, which is sad because they are  such a great resource of information (they know what will be on the test). The  professor will see your dedication and in doing so, it may even bump you up a  grade. </p>
</section>
  
   
<div id="banner"><img src="images/students-corner-header.png" width="950" height="300" alt="banner" /></div>
<div id="apDiv2">
...
<li><a class="MenuBarItemSubmenu" href="Posts.php?Submit=Submit">Notice Board</a>
    ...
    <li><a href="showfile.php">Study Matrial</a>    </li>
...
<div id="loginwrapper"></div>
    ...
    <form method="post" action="./include/session.php" ><input name="log out" type="submit" value="Log Out" /></form><br>
